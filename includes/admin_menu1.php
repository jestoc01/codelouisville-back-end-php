...
<li><a href = "index.php?action=show_about_page">About</a></li>
    ...
    <main>
        <div id="centralheading">
            ...
            <p>The treatment of pain and addiction are two of today's greatest healthcare needs</p>
            <p><a href="index.php?action=show_solution_page">Solution</a></p>
        <p>Our system allows pharmacists, physicians, and patients to work together</p>
            <p><a href="index.php?action=show_about_page">About</a></p>
              <p>Our passion and experience are focused on helping stop addiction</p>      
